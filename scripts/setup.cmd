...
SET DPB_JAR_FILE=%EXAMPLE_ROOT_DIR%\target\dependency\dpbridge-0.0.2-jar-with-dependencies.jar

REM Path to Java JAR file of simple sync host.
SET SYNC_JAR_FILE=%EXAMPLE_ROOT_DIR%\target\dependency\sync-0.0.2-jar-with-dependencies.jar

REM Path to Java JAR file of config server.
SET CONFIG_JAR_FILE=%EXAMPLE_ROOT_DIR%\target\dependency\config-0.1.1-jar-with-dependencies.jar
