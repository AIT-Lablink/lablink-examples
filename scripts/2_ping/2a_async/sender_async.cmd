...
SET PING_SENDER_ASYNC=at.ac.ait.lablink.examples.ping.async.PingSenderAsync

REM Logger configuration.
SET LOGGER_CONFIG=-Dlog4j.configurationFile=%LLCONFIG%ait.example.all.log4j2

REM Start the sender.
"%JAVA_HOME%\bin\java.exe" %LOGGER_CONFIG% -cp %EXAMPLES_JAR_FILE% %PING_SENDER_ASYNC%
