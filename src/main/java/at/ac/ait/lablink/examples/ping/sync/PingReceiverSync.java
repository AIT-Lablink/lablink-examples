...
/**
 * Class PingReceiverSync.
 */
public class PingReceiverSync {

  /** Client name. */
  private static final String CLIENT_NAME = "PingReceiverSync";
  ...
  public static void main( String[] args )
    ...
    PingReceiverSync app = new PingReceiverSync();
    app.setupClient();
  }
  ...
  private void setupClient()
    ...
    PingSyncConsumer sync = new PingSyncConsumer();
    
    MqttCommInterfaceUtility.addClientProperties( client, "A simple receiver.", 
        SCENARIO_NAME, GROUP_NAME, CLIENT_NAME, this.llprop, this.llsync, sync );
